...
The [8080 Microprocessor Kit](https://kswichit.net/8080kit/8080kit.htm) 
shown above is a single board computer developed by [Wichit Sirichote](http://kswichit.net/)
...
on the CPU shows "814", which means it was produced in the 14th week of 1978 - nearly 
48 years ago, and it is still working! 
